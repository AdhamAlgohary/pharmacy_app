...
class EditProducScreen extends StatefulWidget {
  ...
  const EditProducScreen({Key? key, this.editProduct}) : super(key: key);
...
class _EditProducScreenState extends State<EditProducScreen> {
  ...
  TextEditingController numberOfChemicalsController = TextEditingController();
  ...
  @override
  void initState() {
    nameProductController = TextEditingController(text: widget.editProduct);
    super.initState();
  }
