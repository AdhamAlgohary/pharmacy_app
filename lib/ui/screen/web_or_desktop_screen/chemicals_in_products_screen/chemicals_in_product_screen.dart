              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(
                      top: 0.05 * height,
                      bottom: 0.05 * height,
                      left: 0.01 * getwidth(context: context)),
                  child: CustomTxt(
                      txt:
                          "Product : ${context.watch<ProductViewModel>().nameOfProduct}",
                      txtStyle: style1),
                ),
                Center(child: CustomTxt(txt: 'Ingredients:', txtStyle: style1)),
                Padding(
                  padding: EdgeInsets.only(top: 0.05 * height),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      CustomTxt(txt: 'Name Of Chemical', txtStyle: style4),
                      CustomTxt(txt: 'Amount (Grams)', txtStyle: style4),
                      CustomTxt(txt: 'Price Of Chemical', txtStyle: style4)
                    ],
                  ),
                ),
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        leading: SizedBox(
                          width: 0.32 * getwidth(context: context),
                          child: CustomTxt(
                              txt:
                        ...
                        title: CustomTxt(
                            ...
                            txtStyle: style4),
                        trailing: Padding(
                          padding:  EdgeInsets.only(right: 0.15 * getwidth(context: context)),
                          child: CustomTxt(
                              txt:
